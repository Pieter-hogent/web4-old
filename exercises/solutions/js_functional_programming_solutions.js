...
// npm install lodash (if you haven't already)
...
function _exercise13(impactSize) {
  ...
  return impacts.filter(isImpactMassGreaterThan(impactSize)).map(obj => obj.name);
}
...
//-------------------------------------------------------------------
//  DO NOT TOUCH - this checks the correct output of your functions
//-------------------------------------------------------------------
